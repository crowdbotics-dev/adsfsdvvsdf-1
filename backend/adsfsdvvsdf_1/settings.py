"""
Django settings for adsfsdvvsdf_1 project.
...
ROOT_URLCONF = 'adsfsdvvsdf_1.urls'
...
WSGI_APPLICATION = 'adsfsdvvsdf_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "adsfsdvvsdf_1 API",
    "DESCRIPTION": "API documentation for adsfsdvvsdf_1 App",
    "VERSION": "v1",
}
